...
BigNet основан на универсальной блокчейн платформе IZZZIO и разработан одноимённой компанией IZZZIO LLC. (ООО "Изио"). Исходный код платформы открыт и доступен по лицензии Apache-2.0. 
